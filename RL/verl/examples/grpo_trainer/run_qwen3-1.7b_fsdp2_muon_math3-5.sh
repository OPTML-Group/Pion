# Whole-matrix MuonAdamW on Qwen3-1.7B with GRPO / MATH Level 3-5.
...
# All 2D weights (attention + FFN) use whole-matrix Muon; embed/lm_head use AdamW.
...
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0,1 bash examples/grpo_trainer/run_qwen3-1.7b_fsdp2_muon_math3-5.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1.7b_grpo_fsdp2_muon' \
    ...
    actor_rollout_ref.actor.optim.optimizer='MuonAdamW' \
