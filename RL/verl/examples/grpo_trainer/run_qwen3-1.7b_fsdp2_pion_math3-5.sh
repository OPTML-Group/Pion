# Whole-matrix DefaultPionAdamW on Qwen3-1.7B with GRPO / MATH Level 3-5.
# Training data from arxiv:2503.20783 (MATH Level 3-5), using standard GRPO.
# All 2D weights (attention + FFN) use whole-matrix Pion; embed/lm_head use AdamW.
...
#
# Usage:
#   PROMOTION_STEPS=0 CUDA_VISIBLE_DEVICES=0,1 bash examples/grpo_trainer/run_qwen3-1.7b_fsdp2_pion_math3-5.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_1.7b_grpo_fsdp2_pion_exp${PROMOTION_STEPS}" \
    ...
    actor_rollout_ref.actor.optim.optimizer='DefaultPionAdamW' \
