...
if [[ -z "${CUDA_VISIBLE_DEVICES}" ]]; then
    echo "CUDA_VISIBLE_DEVICES is empty. Please set it, e.g. CUDA_VISIBLE_DEVICES=0,1"
    exit 1
fi
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_4b_function_rm_fsdp2_pion_exp${PROMOTION_STEPS}" \
