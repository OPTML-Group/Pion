# Per-head PerHeadPionAdamW on Qwen3-1.7B with GRPO / MATH Level 3-5.
...
#
# Usage:
#   PROMOTION_STEPS=0 CUDA_VISIBLE_DEVICES=0,1 bash examples/grpo_trainer/run_qwen3-1.7b_fsdp2_multihead_pion_math3-5.sh
#   PROMOTION_STEPS=1 CUDA_VISIBLE_DEVICES=2,3 bash examples/grpo_trainer/run_qwen3-1.7b_fsdp2_multihead_pion_math3-5.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_1.7b_grpo_fsdp2_multihead_pion_exp${PROMOTION_STEPS}" \
