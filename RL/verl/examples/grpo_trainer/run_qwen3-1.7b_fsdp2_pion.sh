# Whole-matrix DefaultPionAdamW on Qwen3-1.7B with GRPO / GSM8K.
#
# Pion stages:
...
#
# Usage:
#   PROMOTION_STEPS=0 CUDA_VISIBLE_DEVICES=0,1 bash examples/grpo_trainer/run_qwen3-1.7b_fsdp2_pion.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_1.7b_function_rm_fsdp2_pion_exp${PROMOTION_STEPS}" \
