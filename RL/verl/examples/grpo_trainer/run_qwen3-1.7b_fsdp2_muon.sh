# Whole-matrix MuonAdamW on Qwen3-1.7B with GRPO / GSM8K.
#
...
#
# Usage:
#   CUDA_VISIBLE_DEVICES=4,5 bash examples/grpo_trainer/run_qwen3-1.7b_fsdp2_muon.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1.7b_function_rm_fsdp2_muon' \
