# Per-head PerHeadPionAdamW on Qwen3-4B with GRPO / GSM8K.
#
# Qwen3-4B GQA topology: 32 Q-heads, 8 KV-heads, head_dim=80, hidden=2560
...
#
# Usage:
#   PROMOTION_STEPS=0 CUDA_VISIBLE_DEVICES=0,1 bash examples/grpo_trainer/run_qwen3-4b_fsdp2_perhead_pion.sh
#   PROMOTION_STEPS=1 CUDA_VISIBLE_DEVICES=2,3 bash examples/grpo_trainer/run_qwen3-4b_fsdp2_perhead_pion.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="qwen3_4b_function_rm_fsdp2_multihead_pion_exp${PROMOTION_STEPS}" \
