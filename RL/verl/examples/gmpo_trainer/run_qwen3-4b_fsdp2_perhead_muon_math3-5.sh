# Per-head PerHeadMuonAdamW on Qwen3-4B with GMPO / MATH Level 3-5.
...
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0,1 bash examples/gmpo_trainer/run_qwen3-4b_fsdp2_perhead_muon_math3-5.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_4b_gmpo_fsdp2_perhead_muon' \
