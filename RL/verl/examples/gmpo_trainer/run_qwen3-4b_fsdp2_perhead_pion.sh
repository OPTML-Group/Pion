# Per-head PerHeadPionAdamW on Qwen3-4B with GMPO / GSM8K.
#
...
#
# Usage:
#   PROMOTION_STEPS=0 CUDA_VISIBLE_DEVICES=0,1 bash examples/gmpo_trainer/run_qwen3-4b_fsdp2_perhead_pion.sh
#   PROMOTION_STEPS=1 CUDA_VISIBLE_DEVICES=2,3 bash examples/gmpo_trainer/run_qwen3-4b_fsdp2_perhead_pion.sh
