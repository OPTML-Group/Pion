# Per-head PerHeadPionAdamW on Qwen3-1.7B with GMPO / MATH Level 3-5.
# Training data from arxiv:2503.20783 (MATH Level 3-5), using GMPO.
#
...
#
# Pion stages:
#   promotion_steps=0  → pure Filter (recommended for RLVR/GMPO)
...
#
# Usage:
#   PROMOTION_STEPS=0 CUDA_VISIBLE_DEVICES=0,1 bash examples/gmpo_trainer/run_qwen3-1.7b_fsdp2_multihead_pion_math3-5.sh
#   PROMOTION_STEPS=1 CUDA_VISIBLE_DEVICES=2,3 bash examples/gmpo_trainer/run_qwen3-1.7b_fsdp2_multihead_pion_math3-5.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_gmpo_math3-5' \
    trainer.experiment_name="qwen3_1.7b_gmpo_fsdp2_multihead_pion_exp${PROMOTION_STEPS}" \
