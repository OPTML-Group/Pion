# Per-head PerHeadMuonAdamW on Qwen3-1.7B with GMPO / GSM8K.
#
...
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0,1 bash examples/gmpo_trainer/run_qwen3-1.7b_fsdp2_perhead_muon.sh
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_1.7b_function_rm_fsdp2_perhead_muon' \
