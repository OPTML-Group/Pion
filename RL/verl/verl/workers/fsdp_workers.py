...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        # CPUOffload for actor causes incorrect results with grad accumulation, so always None.
        # For ref, respect the param_offload config (VL models may require params on GPU).
        if role == "ref" and fsdp_config.param_offload:
        ...
        if fsdp_strategy == "fsdp":
            ...
            if role == "actor" and fsdp_config.offload_policy:
                ...
                self._is_offload_param = False
                self._is_offload_optimizer = False
            elif role == "ref" and fsdp_config.param_offload:
                cpu_offload = CPUOffloadPolicy(pin_memory=True)
            else:
                cpu_offload = None
        ...
        if role == "actor" and optim_config is not None:
            ...
            actor_optimizer = build_optimizer(actor_module_fsdp.named_parameters(), optim_config)
