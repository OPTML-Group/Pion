#!/usr/bin/env bash
# Muon baseline for VLA-Adapter on LIBERO.
#
# Routes Vision/Language/Action/Other modules to Muon. 1-D parameters
# (LN/biases/embeddings) automatically stay on the AdamW-aux bucket.
...
wd=${WD:-1e-2}
nproc=${NPROC:-8}
out_dir=${OUT_DIR:-outputs/muon}
run_id_note=${RUN_ID_NOTE:-Muon-${data_name}-${current_time}}
